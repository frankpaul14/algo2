...
private:		
	...
	void buildRecursiveCodes(Node<char>*root)
	{
		buildCodes(root, "");
	}

	void buildIterativeCodes(Node<char>* root)
	{	  
  ...
  public:	  
	  ...
	  {		  
		  HuffmanMinHeap<Node<char>> heap = HuffmanMinHeap<Node<char>>(size);	
		  ...
		  Node<char>* root = heap.extractMin();		  
		  buildIterativeCodes(root);
		  //buildRecursiveCodes(root);
	  }	  
